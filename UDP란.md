...
![img](img/68747470733a2f2f74312e6461756d63646e2e6e65742f6366696c652f746973746f72792f323732413541333835373539323637423336.png)

- 포트 - Destination port : 도착지 포트 - Length : 길이 - _Checksum_ : 오류 검출 - 중복 검사의 한 형태로, 오류 정정을 통해 공간이나 시간 속에서 송신된 자료의 무결성을 보호하는 단순한 방법이다.
...
#### DNS는 UDP 통신 프로토콜을 사용함.

![image-20230626093056278](img/image-20230626093056278.png)
...
IP는 장치에서 장치의 통신, Transport layer에서 프로그램 간의 특별한 통신 식별

Transport layer에서는 TCP, UDP 프로토콜이 있다

UDP는 

- 비연결성, 신뢰성이 없어서 데이터 전송에 오류가 생길 수 있다

- 빠른 데이터 전송이 장점

대표적인 UDP 프로토콜의 예 DNS

- 도메인 주소를 IP주소로 변환

- Application layer protocol
- 전송계층에서 UDP protocol을 사용

사용하는 이유

- 3-way handshake로 connection을 유지할 필요가 없음.
- DNS request는 UDP segment에 꼭 들어갈 정도로 작음.

- reliability는 application layer에 추가될 수 있음. (Timeout 추가나, resend 작업을 통해)
